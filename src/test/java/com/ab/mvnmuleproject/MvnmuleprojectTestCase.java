...
public class MvnmuleprojectTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "mvnmuleproject-functional-test-config.xml";
    }

    @Test
    public void mvnmuleproject() throws Exception
    {
